...
import {validateSchema,isUserAlreadyExist,isUserExists, verifyUserCredentials,isTokenValid} from "../middlewares/validation.js";
import {registerNewUser,loginUser,forgotPassword, resetPassword} from "../modules/auth/authController/authControllers.js";
import { registrationSchema,loginSchema,forgotPasswordSchema,verifyPasswordSchema,verifyLogoutSchema } from "../modules/authValidations/authValidations.js";
...
authRouter.post("/logout",userAuthorization(['client','admin']),(req,res)=>{ res.send("Hello")})
